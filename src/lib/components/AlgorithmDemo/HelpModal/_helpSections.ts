...
const createEncodingHelpSections = (): HelpSection[] => [
	...
	{ id: getRandomHexString(4), title: 'Input Encoding (ASCII)', component: StringInputEncoding1 },
	{ id: getRandomHexString(4), title: 'Input Encoding (Hex)', component: StringInputEncoding2 },
	{ id: getRandomHexString(4), title: 'Input Encoding (Binary)', component: StringInputEncoding3 },
